      ...
      return {
        ...
        link: function(scope, element) {
          ...
          scope.$watch('credential', function() {
            ...
            } else if(scope.credential.credential_id) {
              var url = window.btoa(angular.copy(scope.credential.url));
              scope.iconUrl = OC.generateUrl('apps/passman/api/v2/icon/') + scope.credential.credential_id + '/' + url;
            }
          }, true);
        }
      };
